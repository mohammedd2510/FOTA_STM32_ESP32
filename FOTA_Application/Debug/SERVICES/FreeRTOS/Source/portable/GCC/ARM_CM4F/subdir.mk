...
SERVICES/FreeRTOS/Source/portable/GCC/ARM_CM4F/%.o SERVICES/FreeRTOS/Source/portable/GCC/ARM_CM4F/%.su SERVICES/FreeRTOS/Source/portable/GCC/ARM_CM4F/%.cyclo: ../SERVICES/FreeRTOS/Source/portable/GCC/ARM_CM4F/%.c SERVICES/FreeRTOS/Source/portable/GCC/ARM_CM4F/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DSTM32F401CCUx -DSTM32 -DSTM32F4 -c -I../Inc -I"E:/The Courses/Embedded Systems/ARM Interfacing/FOTA Project/FOTA_Application/SERVICES/FreeRTOS/Source/portable/GCC/ARM_CM4F" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
